export const Rulesets: import('../../../sim/dex-formats').ModdedFormatDataTable = {
	standardag: {
		inherit: true,
		ruleset: [
			'Obtainable', 'Team Preview', 'Cancel Mod', 'Endless Battle Clause', 'Species Clause', 'Item Clause = 1', 'Min Team Size = 6',
		],
	},
	standard: {
		inherit: true,
	...
	flatrules: {
		inherit: true,
		desc: "The in-game Flat Rules: Species Clause, Item Clause = 1, -Mythical, -Restricted Legendary, Bring 6 Pick 3-6 depending on game type.",
		ruleset: ['Obtainable', 'Team Preview', 'Species Clause', 'Nickname Clause', 'Item Clause = 1', 'Picked Team Size = Auto', 'Min Team Size = 6', 'Cancel Mod'],
